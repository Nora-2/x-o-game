                ...
                child: Column(
                  ...
                  [
                    Row(
                      ...
                      children:
                      [
                        Expanded(flex:4,child: playerItem("Current Player",17.5,FontWeight.w500,Color.fromARGB(222, 145, 100, 26),)),
                        const SizedBox(width: 15),
                        Expanded(flex:2,child: playerItem(GameCubit.getInstance(context).currentPlayer,25,FontWeight.bold, Color.fromARGB(222, 145, 100, 26))),
                      ],
                    ),
                    ...
                    const SizedBox(height: 10,),
                    MaterialButton(
                      color: Color.fromARGB(222, 145, 100, 26),
                      height: 50,
  ...
  Widget gameContent(GameCubit cubit){
    return GridView.builder(
        ...
        itemBuilder: (context,i){
          return Card(elevation: 8, child: boxItem(index:i,context:context,cubit:cubit));
        }
    );
  }
  ...
  Widget boxItem({required int index,required BuildContext context,required GameCubit cubit}){
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(4),
          color: cubit.boxesData[index] == cubit.player1 ?  Colors.white :
          cubit.boxesData[index] == cubit.player2 ?  Color.fromARGB(222, 145, 100, 26) : Colors.grey.withOpacity(0.2),
        ),
        alignment: Alignment.center,
        child: AnimatedDefaultTextStyle(
          ...
          style:  TextStyle(
            color: cubit.boxesData[index] == cubit.player1 ? Color.fromARGB(222, 145, 100, 26):Colors.white,
